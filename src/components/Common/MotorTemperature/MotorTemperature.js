...
export default class MotorTemperature extends React.Component {
  constructor(props) {
    super(props);
    this.unitsNum = 39;
  ...
  render() {
    return (
      <View style={styles.motorTempBox}>
        <Svg style={styles.image} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 143.23 191.81">
          <Path fill="#fff" d="M385.84,591.79l-3-.26c-.08,1-.17,2-.26,3A240.6,240.6,0,0,1,314,741.44l-2.12,2.12,2.2,2.2,9.56,9.56,2.12-2.12-9.56-9.56a242.4,242.4,0,0,0,69.44-148.86L399,596l.26-3Z" transform="translate(-311.83 -589.85)"/>
          <Rect id="39" ref={(c) => this.fillSvg(c)} fill="#f00" x="392.26" y="592.32" width="1" height="12" transform="translate(717.03 -319.61) rotate(96)"/>
          <Rect id="38" ref={(c) => this.fillSvg(c)} fill="#fff" x="391.76" y="596.68" width="1" height="12" transform="translate(726.43 -303.07) rotate(97)"/>
          <Rect id="37" ref={(c) => this.fillSvg(c)} fill="#fff" x="391.19" y="601.04" width="1" height="12" transform="translate(735.51 -286.21) rotate(98)"/>
          <Rect id="36" ref={(c) => this.fillSvg(c)} fill="#fff" x="390.54" y="605.38" width="1" height="12" transform="translate(744.24 -269.06) rotate(99)"/>
          <Rect id="35" ref={(c) => this.fillSvg(c)} fill="#fff" x="389.82" y="609.72" width="1" height="12" transform="translate(752.63 -251.61) rotate(100)"/>
          <Rect id="34" ref={(c) => this.fillSvg(c)} fill="#fff" x="389.01" y="614.04" width="1" height="12" transform="translate(760.66 -233.87) rotate(101)"/>
          <Rect id="33" ref={(c) => this.fillSvg(c)} fill="#fff" x="388.14" y="618.34" width="1" height="12" transform="translate(768.31 -215.85) rotate(102)"/>
          <Rect id="32" ref={(c) => this.fillSvg(c)} fill="#fff" x="387.19" y="622.63" width="1" height="12" transform="translate(775.59 -197.56) rotate(103)"/>
          <Rect id="31" ref={(c) => this.fillSvg(c)} fill="#fff" x="386.16" y="626.9" width="1" height="12" transform="translate(782.48 -179.01) rotate(104)"/>
          <Rect id="30" ref={(c) => this.fillSvg(c)} fill="#fff" x="385.06" y="631.16" width="1" height="12" transform="translate(788.97 -160.21) rotate(105)"/>
          <Rect id="29" ref={(c) => this.fillSvg(c)} fill="#fff" x="383.89" y="635.39" width="1" height="12" transform="translate(795.06 -141.17) rotate(106)"/>
          <Rect id="28" ref={(c) => this.fillSvg(c)} fill="#fff" x="382.64" y="639.6" width="1" height="12" transform="translate(800.73 -121.89) rotate(107)"/>
          <Rect id="27" ref={(c) => this.fillSvg(c)} fill="#fff" x="381.32" y="643.8" width="1" height="12" transform="translate(805.97 -102.39) rotate(108)"/>
          <Rect id="26" ref={(c) => this.fillSvg(c)} fill="#fff" x="379.92" y="647.96" width="1" height="12" transform="translate(810.79 -82.68) rotate(109)"/>
          <Rect id="25" ref={(c) => this.fillSvg(c)} fill="#fff" x="378.46" y="652.1" width="1" height="12" transform="translate(815.16 -62.77) rotate(110)"/>
          <Rect id="24" ref={(c) => this.fillSvg(c)} fill="#fff" x="376.92" y="656.22" width="1" height="12" transform="translate(819.08 -42.67) rotate(111)"/>
          <Rect id="23" ref={(c) => this.fillSvg(c)} fill="#fff" x="375.31" y="660.31" width="1" height="12" transform="translate(822.55 -22.39) rotate(112)"/>
          <Rect id="22" ref={(c) => this.fillSvg(c)} fill="#fff" x="373.63" y="664.37" width="1" height="12" transform="translate(825.56 -1.94) rotate(113)"/>
          <Rect id="21" ref={(c) => this.fillSvg(c)} fill="#fff" x="371.87" y="668.4" width="1" height="12" transform="translate(828.1 18.66) rotate(114)"/>
          <Rect id="20" ref={(c) => this.fillSvg(c)} fill="#fff" x="370.05" y="672.39" width="1" height="12" transform="translate(830.16 39.41) rotate(115)"/>
          <Rect id="19" ref={(c) => this.fillSvg(c)} fill="#fff" x="368.16" y="676.36" width="1" height="12" transform="translate(831.75 60.28) rotate(116)"/>
          <Rect id="18" ref={(c) => this.fillSvg(c)} fill="#fff" x="366.2" y="680.29" width="1" height="12" transform="translate(832.84 81.27) rotate(117)"/>
          <Rect id="17" ref={(c) => this.fillSvg(c)} fill="#fff" x="364.17" y="684.19" width="1" height="12" transform="translate(833.45 102.37) rotate(118)"/>
          <Rect id="16" ref={(c) => this.fillSvg(c)} fill="#fff" x="362.08" y="688.05" width="1" height="12" transform="translate(833.56 123.56) rotate(119)"/>
          <Rect id="15" ref={(c) => this.fillSvg(c)} fill="#fff" x="359.91" y="691.87" width="1" height="12" transform="translate(833.17 144.83) rotate(120)"/>
          <Rect id="14" ref={(c) => this.fillSvg(c)} fill="#fff" x="357.68" y="695.66" width="1" height="12" transform="translate(832.27 166.17) rotate(121)"/>
          <Rect id="13" ref={(c) => this.fillSvg(c)} fill="#fff" x="355.39" y="699.41" width="1" height="12" transform="translate(830.87 187.55) rotate(122)"/>
          <Rect id="12" ref={(c) => this.fillSvg(c)} fill="#fff" x="353.03" y="703.11" width="1" height="12" transform="translate(828.95 208.98) rotate(123)"/>
          <Rect id="11" ref={(c) => this.fillSvg(c)} fill="#fff" x="350.6" y="706.78" width="1" height="12" transform="translate(826.53 230.43) rotate(124)"/>
          <Rect id="10" ref={(c) => this.fillSvg(c)} fill="#fff" x="348.11" y="710.4" width="1" height="12" transform="translate(823.58 251.89) rotate(125)"/>
          <Rect id="9" ref={(c) => this.fillSvg(c)} fill="#fff" x="345.56" y="713.97" width="1" height="12" transform="translate(820.11 273.34) rotate(126)"/>
          <Rect id="8" ref={(c) => this.fillSvg(c)} fill="#fff" x="342.95" y="717.51" width="1" height="12" transform="translate(816.13 294.78) rotate(127)"/>
          <Rect id="7" ref={(c) => this.fillSvg(c)} fill="#fff" x="340.27" y="720.99" width="1" height="12" transform="translate(811.62 316.19) rotate(128)"/>
          <Rect id="6" ref={(c) => this.fillSvg(c)} fill="#fff" x="337.54" y="724.43" width="1" height="12" transform="translate(806.6 337.55) rotate(129)"/>
          <Rect id="5" ref={(c) => this.fillSvg(c)} fill="#fff" x="334.74" y="727.82" width="1" height="12" transform="translate(801.04 358.85) rotate(130)"/>
          <Rect id="4" ref={(c) => this.fillSvg(c)} fill="#fff" x="331.89" y="731.16" width="1" height="12" transform="translate(794.97 380.07) rotate(131)"/>
